# This controller is responsible for managing metrics
class MetricsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @metric.save
        format.html { redirect_to metric_url(@metric), notice: notice_t(@metric, :create) }
  ...
  def update
    respond_to do |format|
      if @metric.update(metric_params)
        format.html { redirect_to metric_url(@metric), notice: notice_t(@metric, :update) }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to metrics_url, notice: notice_t(@metric, :delete) }
